...
public activate(String a,String name)
    {
        String mail =a;
        initComponents();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try
        {
            ...
            String insertquery="update "+bank+" set status="+1+" where ac_no='"+acno+"'";         
               PreparedStatement ps1=con.prepareStatement(insertquery);
               ps1.executeUpdate();
             JOptionPane.showMessageDialog(null, jLabel2.getText()+" you Account is now Activated");
